...
class AppStringSwitch extends StatefulWidget {
  ...
  @override
  State<AppStringSwitch> createState() => _AppStringSwitchState();
}

class _AppStringSwitchState extends State<AppStringSwitch> {
  late bool _value;
  ...
  void initState() {
    ...
    _value = widget.controller.text.toLowerCase() == 'active';
  }
